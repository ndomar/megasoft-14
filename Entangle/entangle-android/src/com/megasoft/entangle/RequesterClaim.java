...
public class RequesterClaim extends Activity {
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		requesterMail = this.getIntent().getStringExtra("sender");
		...
		mssg.setMinLines(9);
		fromMail.setText(requesterMail);
	...
	public void sendClaimForm(View view) {
		...
		mssgBody = ((EditText) findViewById(R.id.mssgText)).getText()
				.toString();
		if (requesterMail.equals("") || tangleOwenerMail.equals("")) {
			...
			try {
				object.put("X-SENDER-MAIL", requesterMail);
