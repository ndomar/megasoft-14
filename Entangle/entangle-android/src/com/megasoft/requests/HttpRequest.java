...
public abstract class HttpRequest extends AsyncTask<String, String, String> {
	...
	/**
	 * This method is called from the subclasses to pass the request method used
	 * to this class
	 * 
	 * @param request
	 *            , The request class passed from the subclass
	 */
	...
	/**
	 * @return false if the status code was anything other than 2XX after
	 *         executing the request , true otherwise
	 */
	...
	/**
	 * This is the method responsible for executing the request and handling the
	 * response
	 * 
	...
	/**
	 * A setter method to set whether the request has a body or not , used
	 * between this class and its subclasses
	 * 
	 * @param hasBody
	 *            boolean
	 */
