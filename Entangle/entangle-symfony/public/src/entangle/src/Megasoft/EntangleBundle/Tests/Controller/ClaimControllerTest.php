   ...
   public function testCreateClaimAction_NullSessionId() {
    ...
    public function testCreateClaimAction_ExpiredSession() {
           ...
           $client->request('POST',
                   ...
                   array(),
                   array(),
                   array('HTTP_X_SESSION_ID', 'session_userMohamed'));
           $response = $client->getResponse();
     ...
     */
       ...
       public function testCreateClaimAction_WrongOfferStatus() {
           ...
           $client = static::createClient();
           $client->request('POST',
                   'claim/2/sendClaim/2/user',
                   array(),
                   array(),
                   array('HTTP_X_SESSION_ID', 'session_userAly'));
           $response = $client->getResponse();
       ...
       public function testCreateClaimAction_UserNotInTangle() {
           ...
           $client = static::createClient();
           $client->request('POST',
                   'claim/6/sendClaim/7/user',
                   array(),
                   array(),
                   array('HTTP_X_SESSION_ID', 'session_userAhmad'));
           $response = $client->getResponse();
