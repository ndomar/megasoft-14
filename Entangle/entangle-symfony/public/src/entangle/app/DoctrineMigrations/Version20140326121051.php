 ...
 */
class Version20140326121051 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE Notification (id INT AUTO_INCREMENT NOT NULL, seen TINYINT(1) NOT NULL, created DATETIME NOT NULL, userId INT NOT NULL, type VARCHAR(255) NOT NULL, transactionId INT DEFAULT NULL, tranactionId INT DEFAULT NULL, oldPrice INT DEFAULT NULL, newPrice INT DEFAULT NULL, requestId INT DEFAULT NULL, messageId INT DEFAULT NULL, INDEX IDX_A765AD3264B64DCC (userId), INDEX IDX_A765AD32B8B55E6A (tranactionId), INDEX IDX_A765AD32A1637001 (requestId), INDEX IDX_A765AD32A4C3A0DA (messageId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE User (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, primaryEmailId INT NOT NULL, passowrd VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, userBio VARCHAR(255) NOT NULL, birthDate DATE NOT NULL, verified TINYINT(1) NOT NULL, primaryEmail_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_2DA17977EE9506D6 (primaryEmail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE Notification ADD CONSTRAINT FK_A765AD32B8B55E6A FOREIGN KEY (tranactionId) REFERENCES Transaction (id)");
        ...
        $this->addSql("ALTER TABLE User ADD CONSTRAINT FK_2DA17977EE9506D6 FOREIGN KEY (primaryEmail_id) REFERENCES UserEmail (id)");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE Notification DROP FOREIGN KEY FK_A765AD32B8B55E6A");
        ...
        $this->addSql("ALTER TABLE User DROP FOREIGN KEY FK_2DA17977EE9506D6");
